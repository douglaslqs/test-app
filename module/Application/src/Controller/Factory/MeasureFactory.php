...
use Application\Form\MeasureForm;
use Application\Controller\MeasureController;
use Application\Service\ResponseService;
use Application\Service\FilterService;
use Application\Service\LoggerService;

class MeasureFactory implements FactoryInterface
{
	public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
	{
	    $table = $container->get(MeasureTable::class);
	    ...
	    $controller->setForm(new MeasureForm());
	    return $controller;
	}
}