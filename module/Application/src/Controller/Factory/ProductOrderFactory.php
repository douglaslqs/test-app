...
use Application\Form\ProductOrderForm;
use Application\Controller\controller;
use Application\Service\ResponseService;
use Application\Service\FilterService;
use Application\Service\LoggerService;

class ProductOrderFactory implements FactoryInterface
{

	public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
	{
	    $table = $container->get(ProductOrderTable::class);
	    ...
	    $controller->setForm(new ProductOrderForm());
	    return $controller;
	}
}